    ...
    for ind,row in df_match.iterrows():
        ...
        if (is3levels_home and is3levels_away):
            ...
            if (pd.isna(gk_handling_rating)):
                ...
                print("3v3 Goalkeeper not found!")
...
#//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////         
            ...
            if (pd.isna(gk_handling_rating)):
                gk_handling_rating = 50
                print("3v3A Goalkeeper not found!")
            ...
            if (pd.isna(gk_handling_rating)):
                gk_handling_rating = 50
                print("4v4 Goalkeeper not found!")
...
#//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////         
            ...
            if (pd.isna(gk_handling_rating)):
                gk_handling_rating = 50
                print("4v4A Goalkeeper not found!")
            ...
            if (pd.isna(gk_handling_rating)):
                gk_handling_rating = 50
                print("5v5 Goalkeeper not found!")
...
#//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////         
            ...
            if (pd.isna(gk_handling_rating)):
                gk_handling_rating = 50
                print("5v5A Goalkeeper not found!")
            ...
            if (pd.isna(gk_handling_rating)):
                gk_handling_rating = 50
                print("3v5 Goalkeeper not found!")
...
#//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////         
            ...
            if (pd.isna(gk_handling_rating)):
                gk_handling_rating = 50
                print("3v5A Goalkeeper not found!")
            ...
            if (pd.isna(gk_handling_rating)):
                gk_handling_rating = 50
                print("5v3 Goalkeeper not found!")
...
#//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////         
            ...
            if (pd.isna(gk_handling_rating)):
                gk_handling_rating = 50
                print("5v3A Goalkeeper not found!")
            lines[atk_kep_line] = f"AtkKep = [pos[C] == 1]Kep_1({short_pass_rating}, {long_pass_rating}, C);\n"
            lines[def_kep_line] = f"DefKep = [pos[C] == 1]Kep_2({int(gk_handling_rating)}, C);\n"
            prob_to_lose_home_forwards, aggression_home_forwards = create_prob_to_lose(forwardIdsHome, df_ratings, home)
            ...
            if (pd.isna(gk_handling_rating)):
                gk_handling_rating = 50
                print("4v5 Goalkeeper not found!")
...
#//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////         
            ...
            if (pd.isna(gk_handling_rating)):
                gk_handling_rating = 50
                print("4v5A Goalkeeper not found!")
            ...
            if (pd.isna(gk_handling_rating)):
                gk_handling_rating = 50
                print("5v4 Goalkeeper not found!")
...
#//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////         
            ...
            if (pd.isna(gk_handling_rating)):
                gk_handling_rating = 50
                print("5v4A Goalkeeper not found!")
            ...
            if (pd.isna(gk_handling_rating)):
                gk_handling_rating = 50
                print("3v4 Goalkeeper not found!")
...
#//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////         
            ...
            if (pd.isna(gk_handling_rating)):
                gk_handling_rating = 50
                print("3v4A Goalkeeper not found!")
            ...
            if (pd.isna(gk_handling_rating)):
                gk_handling_rating = 50
                print("4v3 Goalkeeper not found!")
            # Define the line number of AtkKep and DefKep in the file
...
#//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////         
            ...
            if (pd.isna(gk_handling_rating)):
                gk_handling_rating = 50
                print("4v3A Goalkeeper not found!")
            lines[atk_kep_line] = f"AtkKep = [pos[C] == 1]Kep_1({short_pass_rating}, {long_pass_rating}, C);\n"
            lines[def_kep_line] = f"DefKep = [pos[C] == 1]Kep_2({int(gk_handling_rating)}, C);\n"
            prob_to_lose_home_forwards, aggression_home_forwards = create_prob_to_lose(forwardIdsHome, df_ratings, home)
...
def create_prob_to_lose(id_array, df_ratings, curr_team):
    ...
    for ind in range(no_of_forwards):
        ...
        marking_rating = curr_team_ratings_row[0][df_ratings.columns.get_loc('defending_marking')]
        if (pd.isna(marking_rating)):
            marking_rating = curr_team_ratings_row[0][df_ratings.columns.get_loc('mentality_positioning')]
        marking_ratings = marking_ratings + int(marking_rating)
    prob_to_lose_curr_team = math.ceil(combined_ratings / no_of_forwards)
    marking_curr_team = math.ceil(marking_ratings / no_of_forwards)
